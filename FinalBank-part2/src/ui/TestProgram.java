...
public class TestProgram extends Application {
	...
	public void start(Stage arg0) throws Exception {
		...
		/*ArrayList<ApplicationBase> tempViews = new ArrayList<ApplicationBase>();
		tempViews.add(app);
		Controller controller1 = new Controller(model, tempViews);
		*/
        ...
        try {
			...
			model.setComponents(clientsArray, atmsArray, bankersArray);
        	
        	app.start(new Stage(),clientsArray, atmsArray, bankersArray,  model);
        	//app.start(new Stage(), model);
